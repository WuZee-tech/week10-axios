...
app.get('/', (req, res)=>{
    let url = 'https://api.themoviedb.org/3/movie/123?api_key=4ca94f8b470d7e34bd3f59c3914295c8';
    axios.get(url)
    .then(response =>{
...
app.get ('/search', (req, res) =>{
    res.render('search', { movieDetails: null });
});
...
app.post('/search', (req, res) =>{
    ...
    let moveiUrl = `https://api.themoviedb.org/3/search/movie?api_key=4ca94f8b470d7e34bd3f59c3914295c8&query=${userMovieTitle}`;
    let genresUrl = 'https://api.themoviedb.org/3/genre/movie/list?api_key=4ca94f8b470d7e34bd3f59c3914295c8&language=en-US';

    let endpoints = [moveiUrl, genresUrl];
...
app.post('/getmovie', (req, res) => {
	...
	const reqUrl = encodeURI(
		`https://api.themoviedb.org/3/movie/550?t=${movieToSearch}&apikey={986f778367f94c0917c51479eded370a}`
	);
	http.get(
		reqUrl,
		responseFromAPI => {
